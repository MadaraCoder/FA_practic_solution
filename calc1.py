# В этот список я записал все слова которые есть в промежутке от 0 до 1000
...
# Как итог в списке nums содержатся названия чисел от 0 до 999, то есть индекс названия числа равен самому числу
...
# Получение ввода от пользователя и передача строки в функцию
while True:
    user_string = input('>>> ')
